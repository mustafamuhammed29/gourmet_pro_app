...
import 'package:gourmet_pro_app/app/modules/analytics/analytics_binding.dart';
import 'package:gourmet_pro_app/app/modules/analytics/analytics_screen.dart';
...
import '../modules/ai_features/review_responder/review_responder_binding.dart';
import '../modules/ai_features/social_post_generator/social_post_generator_binding.dart';
import '../modules/main_wrapper/main_wrapper_screen.dart';
import '../modules/market_analysis/screens/restaurant_details_screen.dart';
import '../modules/product_management/screens/manage_menu_screen.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: Routes.reviewResponder,
      page: () => const ReviewResponderScreen(),
      binding: ReviewResponderBinding(),
    ),
    GetPage(
      name: Routes.socialPostGenerator,
      page: () => const SocialPostGeneratorScreen(),
      binding: SocialPostGeneratorBinding(),
    ),
    GetPage(
      name: Routes.manageMenu,
      page: () => const ManageMenuScreen(),
      binding: ProductManagementBinding(),
    ),
    GetPage(
      name: Routes.addEditDish,
      page: () => const AddEditDishScreen(),
      binding: ProductManagementBinding(),
    ),
    GetPage(
      name: Routes.chefCorner,
      page: () => const ChefCornerScreen(),
      binding: ChefCornerBinding(),
    ),
    GetPage(
      name: Routes.discoverMap,
      page: () => const DiscoverMapScreen(),
